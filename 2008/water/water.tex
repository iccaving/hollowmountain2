...
freefall\sidenote{\passage{Kletnikov Skropilnik} AKA Kletnik's Shower}. At this point, there was no choice left: being as cold as we
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Clewin Griffith and James Kirkpatrick. \pic{Jana Čarga}} \label{clewin jkp mig}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
