...
\tweet{2:56 AM, Jul 19th}{Late for ferry due to usual set off cock ups. Speed limited to 62 dammit! Jarv}
...
After a section of acrobatic rift below \passage{Kill'em All} (p22m),
\passage{Dark Tranquillity} (p42m) was discovered. The leads were very much
...
bridge is 21 meters directly above \passage{Dark Tranquility}, so it
...
to the \passage{Space Odyssey / Concorde} pitch in the main \passage{Vrtnarija} shaft
...
surface cave, \passage{E1}, was discovered in 2007 with a \textasciitilde20
...
\bignote{indicates that \passage{Primadona} itself is a very fertile area for
further exploration.}
...
\passage{Plopzilla} (P105). The objectives were to photograph the large
