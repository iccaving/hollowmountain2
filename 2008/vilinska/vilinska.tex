...
lead)}
 ...
 \margininbox{Vilinska Jama}{
     \begin{itemize}
    \item Tetley
    \item Dan Greenwald
    \item Janet Cotter (Guard)
    \item Bozo
    \end{itemize}}{\dig}
...
Tetley led the way down past \passage{Gardeners' World}. Only grudgingly agreeing that blind
...
\tweet{10:53 AM Jul 27th, 2008}{New cave found by JNH, 100m from GW. Howling draft, goes to new pitch head (proper cave, now fault control).}
...
names. We settled on \passage{Vilinksa Jama} (Veela cave) and returned to the Bivi
for Tea \& Medals. 
