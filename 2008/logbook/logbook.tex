...
\end{subfigure}
  \caption{A trip into \passage{M16}. \textit{(a)} Andy and Jana kitting up for the trip outside \passage{M16}. \pic {Jarvist Frost} \textit{(b)} Andy negotiating the \passage{Gladiators} traverse. \pic {Jana Čarga}}
\end{figure*}
