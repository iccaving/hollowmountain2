\section{Logbook reports: Early trips}
...
\centering
 ...
 \caption{The obligatory morning faff in the \protect\passage{Bivi} takes just as long regardless of weather. \pic{Jana Čarga}}
 \label{sunny morning bivi}
\end{marginfigure}


After the obligatory morning faff in the \passage{Bivi} \bignote{we started off for
...
First trip for me down to \passage{Mudslump}. Lovely trip. It is
...
Have taken the \passage{Gladiators} old rope out. Amazing trip!
...
\end{subfigure}
  \caption{A trip into \passage{M16}. \textit{(a)} Andy and Jana kitting up. \pic {Jarvist Frost} \textit{(b)} Andy negotiating the \passage{Gladiators} traverse. \pic {Jana Čarga}}
\end{figure*}
