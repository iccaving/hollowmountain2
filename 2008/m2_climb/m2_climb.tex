...
trips down \passage{M2} and was amazed by alpine caving on Migovec: the
...
\passage{Kill'em All}, the most insane piece of rigging I have ever been
exposed to.
...
yourself into the rift and unclip. \bignote {In retrospect criminally dangerous
...
terrifying. I think that \bignote {Gergely's singing helped a lot}. At the time it
felt like a great achievement. But it did not lead to the connection.


   \margininbox{Primula traverse}{
     \begin{itemize}
    \item James Kirkpatrick
    \item Izi Mozir
    \end{itemize}}{\explo}
...
bottom of \passage{Captain Kangaroo} with Izi. On that trip we discovered
