...
\caption{Grega Maffi, Karin Rutar and Tjaša Rutar at camp \passage{X-Ray} on the final pushing trips of the expo. \pic{Nejc Maver}} \label{x-ray pushing}
\end{pagefigure}
...
\caption{Fresh out of the cave from the derig and final push, smiling widely, Jim and Gergely (Karin approaching) shake hands over achieving the connection. \pic{Jana Carga}} \label{connection handshake 1}
\end{pagefigure}