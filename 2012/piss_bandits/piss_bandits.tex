...
\caption{Alongside all the obvious wind dangers, at times the wind can also make certain seats in the \passage{Bivi} more hazardous than others; here, Dewi Lloyd (in the tea seat) is harassed by smoke from the Kelly Kettle. \pic{Tharatorn Supasiti}} \label{kettle smoke}
\end{figure*}
...
\caption{Sam Page, Jonathon Hardman and Nikolas Kral in the garden of \passage{Tetley's flat} in \passage[town]{Tolmin}. \pic{Jarvist Frost}} \label{flat garden}
\end{figure}