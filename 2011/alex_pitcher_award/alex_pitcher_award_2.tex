...
itself, we both seemed reluctant to do so.
    ...
    \begin{figure*}[t!]
        ...
        \caption{Life up top. \textit{(a)} Gergely, Nia, Jonny, Clare and Kate.
            \textit{(b)} Hanging out in the \protect\passage{Bivi}. \pic{Gergely Ambrus}
...
chamber of comparable size to \passage{Big Rock Candy Mountain}. Unfortunately, climbing over to it
