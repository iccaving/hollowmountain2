...
\textit{2.8.2011 22:00} -- Nejc \& Karin. We came down around 4:00 had some tea and then we went to \passage{Lower Pleasure}. We tried to bolt it but we just couldn't. We came back and sleep. Nejc is sick so we're going out. There is some rope in \passage{Lower Pleasure} left (I think 2 pieces about 10-20 m long). \name{Karin}}


\fullwidthbox{1-8-11 Jarv and Dan}{

Yesterday we worked on the pitch below \passage{Long Water}. Didn't much like the
wet way pushed by Myles \& Mike, we went off \passage{Rotten Row}.
...
\section{Bolt climbing in Queen's Bed Chamber}
...
\margininbox{Queen's Bed Chamber}{
     \begin{itemize}
    \item Gergely Ambrus
    \item Izi Možir
    \end{itemize}}{\explo}
...
\tweet{6:19PM Jul 29th, 2011}{Well over 500m new now,another large rotation of underground campers this weekend.Weather finally pleasant ish, even saw stars last night!}
