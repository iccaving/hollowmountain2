...
\caption{Sandeed and cheesus [sic] in stores \pic{Jarvist Frost}}
\end{marginfigure}

\subsection{\passage{Plop} Goes!}
...
\subsection{\passage{M1} \& \passage{M6}}
...
\subsection{\passage{U-Bend} connected to \passage{Primadona}}

Hard pushing by Sandeep and Alvin through the previously blown \passage{Enigma
squeeze} on the 40 m \passage{U-bend} pitch has led to a connection with the \passage{Druigi Vhod}
...
\subsection{\passage{Razor Cave} survey}
...
\begin{pagefigure}
      ...
      \centering
              \frame{\includegraphics[width=\linewidth]{2007/expedition_findings/jana carga - planika - cliff abseil--orig.jpg}} 
...
Digging at the bottom of this snow slope gained another snow filled chamber, with `phreatic' esque passage etched through the snow by the draught, and extremely drippy snow which I believe is certainly feeding a faithful stream, possibly the one that was found on Smer0 in \passage{Primadona}, 200 m below. 
...
\subsection{\passage{Primadona} \passage{Smer0}
pitch}
...
\subsection{\passage{Smashed Swede}}
...
\subsection{\passage{East Pole} (\passage{S1})}

Further work was undertaken in \passage{East Pole}: a number of promising new
...
\begin{pagefigure}
  ...
  \caption{A surface, quite literally being bashed \pic{Jarvist Frost}}
\end{pagefigure}
