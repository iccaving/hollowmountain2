...
\begin{marginfigure}
  ...
  \caption{The \passage{Planika Jama} cliff abseil. \pic{Jana Čarga}}
\end{marginfigure}
...
Jana \& I went with Aljošha and Špela to \passage{B9}, and explained the
...
\begin{marginfigure}
  ...
  \caption{The triangular rock arch in \passage{Planika Jama}. \pic{Jarvist Frost}}
\end{marginfigure}
...
Aljošha and Špela had gone down to \passage{Kal}, taken the ICCC rigging gear
...
entrance pitch on the \passage{Migovec} plateau. From a bolt placed in the ceiling a
...
within a metre of the \passage{Yorkshire Pudding} - it must be the same snow slope), and there was a beautiful inlet which had formed some amazing
ice-pearls. 
...
\centering
 ...
 \caption{GPS on the \protect\passage{B9} boulder cairn. \pic{Jarvist Frost}}
\end{marginfigure}
...
Emil and Ben headed back to the \passage{Bivi} while Jana \& I bolted down with
the \passage{Planika} rope to reach \passage{Monatip} in order for him \& Izzy to surface and cave survey the following day. Glorious weather, we sat watching the sun set behind \passage[mountain]{Krn}, with the Venetian bay visible beyond.
...
\begin{marginfigure}
  ...
  \caption{The \passage{Planika Jama} entrance pitch. \pic{Jarvist Frost}}
\end{marginfigure}
