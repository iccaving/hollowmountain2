...
\margininbox{Trips Below Zimmer}{
     \begin{itemize}
    \item Gergely Ambrus
    \item Jana Čarga
...
\begin{subfigure}{0.49\textwidth}
    ...
    \end{subfigure}
 \caption{\protect\passage{Below Zimmer}. \textit{(a)} The entrance to the area from \protect\passage{Zimmer}. \pic{Jarvist Frost} \textit{(b)} Cascade on the way to the first pitch, \protect\passage{Eggstravaganza}, in \protect\passage{Below Zimmer}. \pic{Jana Čarga} \textit{(c)} First pool beneath the first pitch. \textit{(d)} Second pool beneath the first pitch. \pic{Jarvist Frost} }
\end{pagefigure}
...
\centering
 ...
 \caption{The head of \protect\passage{Eggsplosive} pitch beyond \protect\passage{Eggstravaganza}, left as a going lead for 2010. \pic{Jarvist Frost}}
