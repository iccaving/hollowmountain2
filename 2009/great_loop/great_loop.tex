...
\centering
 ...
 \caption{Dan at \protect\passage{Camp X-Ray}, 6 years after its last use as an underground camp. \pic{Jarvist Frost}}
 \label{xray 2009}
\end{figure*}
...
\centering
 ...
 \caption{Dan beneath the boulders in \protect\passage{Hanging Garden}. \pic{Jarvist Frost}}
...
\centering
 ...
 \caption{The 2009 expedition was sponsored by BEAST. The donated sets of thermal underlayers helped make underground camping comfortable. \pic{Mike Foley}}
 \label{beast thermals}
\end{pagefigure}

\tweet{1:24PM Aug 19, 2009}{Caves derigged! Last camp a bit of an epic photo, survey, push, via zimmer and then up into metal camp. Carries today, last bit of surve ...}
...
\centering
 ...
 \caption{The spoon garden at \protect\passage{Metal Camp}. \pic{Jarvist Frost}}
 \label{spoons}
\end{figure}


\margininbox{Herman Herz, 2010}{
     "William French - for everything from \textbf{freeclimbing to the bottom of \protect\passage{S1} (having passed the pitch rigger on the way down somehow)}, getting down \protect\passage{Swinsto Hole} \& up the great aven before realising that both leg harness buckles were undone and working rather loose, getting ponytail trapped in descender on \protect\passage{Bar Pot} \& having to cut it all off, etc."}{\award}
