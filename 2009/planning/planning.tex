...
\caption[Overlay of pre-2009 Survex data with an overground photograph of Tolminski Migovec]{Opaque overlay of Survex data of the cave systems under \passage{Tolminksi Migovec} with an overground photograph of \passage{Tolminksi Migovec}, taken from \passage{Tolminksi Ravne}.}
\end{survey}
    ...
    \subsection{Radio Direction Finding to colocate end of M2 c.f. end of Capt K?}
        ...
        \end{itemize}
\tweet{11:34AM May 20th, 2009}{Beast Products is graciously sponsoring us with UG fleeces. Funding from GPF and ICU. Ferry Booked. Slideshow T'min lib 8pm Sat 22nd Aug.}
...
\end{marginfigure}  
    ...
    \subsection{Surface Survey}
        \begin{itemize}
            ...
            \item Panorama photo from \passage{Kuk}? Calibrated against bearings?
