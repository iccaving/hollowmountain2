\chapter{Appendix C --- Slovenian / Slovenščina}
Dated 2007.
...
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/Jarvist Frost - canon a520 - sysmig - JC AJ trip - Andy coming up Brezno Strahov--orig.jpg}} 
 \caption{Andy coming up \protect\passage{Brezno Strahov} (Ghost pitch) in \protect\passage{M16}. \pic{Jana Carga}}
 \label{brezno}
\end{marginfigure}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2009-Jana Carga - Canon 350d - 219_1--orig.jpg}} 
 \caption{Rain (dež) in the mountains. \pic{Jana Carga}}
 \label{dež}
\end{marginfigure}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2009-Jana Carga - Canon 350d - 143_1--orig.jpg}} 
 \caption{Typically, once sunset is finished each night on expedition will feature a round of hot drinks in the bivi. Afterwards people will begin to head to bed. They'll all say lahko noč (good night) on their way out - although the pronunciation of 'lahko' will vary considerably. \pic{Jana Carga}}
 \label{nighttime tea}
\end{marginfigure}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2011-08-12-09.59.58-Gergely Ambrus-Canon450D-IMG_1399-Mountain Derig--orig.jpg}} 
 \caption{The two bicycles (dve kolesi) used to cycle from Ravne to Tolmin, until their respective deaths. \pic{Gergely Ambrus}}
 \label{kolo}
\end{marginfigure}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/Jana Carga - Canon 350D - img_2999 bivi on a sunny late morning--orig.jpg}} 
 \caption{The rock bridge over the bivi, late in the morning (jutro). \pic{Jana Carga}}
 \label{jutro}
\end{marginfigure}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2009-08-17-11.13.23 - Tharatorn Supasiti - Plateau at dawn 1 - IMG_5386-1--orig.jpg}} 
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2011-08-14-19.10.45-Jarvist Frost-CanonG5-IMG_0203 - many crates safely back in stores--orig.jpg}} 
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2009-07-26-22.36.40 - Tharatorn Supasiti - Train Journey 5 - IMG_5280-1--orig.jpg}} 
 \caption{Many expedition veterans have made their way to [town]Tolmin via train (vlak) and/or bus (avtobus). \pic{Tharatorn Supasiti}}
 \label{Thara train}
\end{marginfigure}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/jarvist frost - bruno the bivi salad master--orig.jpg}} 
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2012-08-16-19.04.11-Rhys Tyers-Pentax X90-IMGP3432--orig.jpg}} 
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/Gergely Ambrus - DSLR - img_4879--orig.jpg}} 
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2012-07-13-1850JarvistMooreFrost-DSC_0262--orig.jpg}} 
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{appendices/Slovenian/2012-08-16-0654-GergelyAmbrus-IMG_2627--orig.jpg}} 
