...
of \passage[town]{Tolmin}, the JSPDT. From \passage[town]{Tolmin} we travelled 6 km to the large limestone plateau of \passage[mountain]{Tolminski
...
\tweet{10:24PM Jul 18, 2010}{Van safely T'min sat evening.Alpine start delayed by thunder. Carries in rain. 15 up the hill,1st slop and tea.Great to be back in the bivi!}
...
Camp on \passage[mountain]{Migovec} consists of tents dotted around the plateau and a communal living space known as
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{2010/ap_awards/20100813-15-28-44 - Jana Carga 67--orig.jpg}} 
 \caption{Sometimes there are things at \passage[town]{Ravne} that add extra enjoyment to a carry. \pic{Jana Čarga}}
 \label{ravne kitten}
\end{marginfigure}
...
trip was to \passage{Gardeners' World}, also known as \passage{Vrtnarija}, one of the two main cave systems in \passage{Migovec}.
...
largest pitches I had ever seen, the largest being \passage{Concorde} (my favourite pitch), which at 90 m high is
...
Leopard spot shaped mud splats on the walls, it soon became known instead as \passage{Cheatah}[sic], due to that
...
caves after \passage{Cheatah}[sic] are majestic. Large amphitheatre-like holes, gloriously decorated passages and
...
and emotionally drained. \passage{Cheatah}[sic] was no more pleasant going up than coming down, the slippery
mud made it frustratingly tricky to reach the top. Glad to be back at camp.

    \begin{marginfigure}
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
\centering
 \frame{\includegraphics[width=\linewidth]{2010/ap_awards/Jarvist Frost - Canon A1 Zenit 16mm - 61320036--orig.jpg}} 
 \caption{Unable to beat the rain, Kate and Myles play chess. \pic{Jarvist Frost}}
 \label{chess game}
\end{marginfigure}
...
next few days the rain came which kept the cavers underground and the rest of us huddled in the \passage{Bivi}. These days were dedicated to games of chess and cards. After the rain had ceased I had a little trip
...
then travelled down to \passage[town]{Tolmin} and enjoyed luxuries such as pizza and swims in the emerald green
...
\end{subfigure}
  \caption{\textit{a}) Dan Greenwald on the \protect\passage{Serpentine} pitch. \pic {Iztok Možir} \textit{b}) Kate at the bottom of \protect\passage{Zimmer}. \pic{Jarvist Frost}}
\end{figure*}
...
The next few days were spent \bignote{packing away the \passage{Bivi}, removing all evidence of our presence} in the
...
\tweet{7:12PM Aug 11, 2010}{Cave\&UG camp fully derigged last night.Beaut weather for carries down,raspberries ripe. Stunning last sunset as an end to an epic expo. ICCC}
